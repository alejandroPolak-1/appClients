...
// const Color kcPrimaryColor = Color(0xffE4F353);
const Color kcPrimaryColorDark = Color(0xFF300151);
const Color kcDarkGreyColor = Color(0xFF1A1B1E);
const Color kcMediumGrey = Color(0xFF0D1E32);
const Color kcLightGrey = Color.fromARGB(255, 187, 187, 187);
const Color kcButtonBackgroundColor = Color(0xFF000000);
...
const Color kcPopupIcon = Color(0xFFFFFFFF);
...
const Color kcColorDottedImage = Color(0xffE4F353);
